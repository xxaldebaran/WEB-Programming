...
import {VALIDATOR_EMAIL,VALIDATOR_MINLENGTH,VALIDATOR_REQUIRE} from 'D:/OneDrive/vu uni/web programming/front end/src/shared/components/util/validators.js';
...
const Auth = () => {
  ...
  const switchModeHandler = () => {
    ...
    if (!isLoginMode) {
       //clear the form and set form validity when switching to login mode
      setFormData(
        {
          ...formState.inputs,
          name: undefined,
  ...
  const authSubmitHandler = async event => {
    ...
    if (isLoginMode) {
      ...
      //signup mode: send signup request
      try {
    ...
    <React.Fragment>
      ...
      <Card className="authentication">
        ...
        <form onSubmit={authSubmitHandler}>
          ...
          {/* Render input fields based on the mode (login/signup) */}
          {!isLoginMode && (
            <ImageUpload
              center
              id="image"
